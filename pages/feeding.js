...
export default function Feeding() {
    ...
    return(
        <PageContainer suppressHydrationWarning={true}>
            ...
            <h3>
                <p>
                    Раціон маїсового полоза — це миші (інколи можна давати мастомісів та щурів).
                    Розмір миші повинен бути не більшим за найтовщу частину змії (приблизно середина її тіла), але і не сильно меншим.
                ...
                <p>
                    Маленька змія їсть раз на 4-5 днів. Потім по мірі зростання годувати треба рідше.
                    Десь до 4-х місяців годуйте змію на 5-й день.
                    ...
                    Активно росте полоз перші три роки, а потім ще близько року підростає, але повільно.
                </p>
                <p>
