...
export default function Reproduction() {
    return(
        <PageContainer>
            ...
            <h3>
                <p>
                    Маїсів можна не вводити в сплячку, особливо маленьких.
            ...
            <h3>
                <p>
                    ...
                    За рік може бути дві кладки в період пізня весна - рання осінь.
                </p>
                <p>
                    Вагітність полоза триває 36-38 днів. За два тижні до відкладання яєць, самка може перестати їсти, як би довго ви не пропонували їй мишей.
                    Залиште її в спокої, вона не буде їсти до тих пір, поки не відкладе яйця.
                ...
                <p>
                    ...
                    Вологість в інкубаторі повинна триматись від 85% до 99% на постійній основі.
            ...
            <h3>
                <p>
                    ...
                    Маленькі полози можуть відмовлятися від мишки. Тому можете пропонувати і розморожену, і живу.
                    ...
                    Спершу спробуйте покласти мишку в контейнер до маїса максимум на годину, щоб в ній не розмножувались бактерії.
                    Якщо миша залишиться нез'їденою, то повторно заморожувати її категорично заборонено.
                </p>
                <p>
                    Без наслідків для здоров’я голодувати маленькі маїсові полози можуть до трьох тижнів.
                    Тому, якщо три тижні вже минули, а змія так і не поїла — годуйте насильно.
                    Як це робити, можна подивитись відео на платформі YouTube або проконсультуйтесь у лікаря-герпетолога.
                </p>
                <p>
