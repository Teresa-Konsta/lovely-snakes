    ...
    return(
        <PageContainer>
            ...
            <h3>
                ...
                <p>
                    Якщо ви хочете з природи принести в тераріум гарну колоду, щоб змійка по ній повзала (до речі і линяти їй буде легше), то ви повинні її продезінфікувати. 
            ...
            <h3>
                <p>
                    Приносити мох з вулиці — погана ідея. Звісно, ви можете його обробити так само, як і колоду, але він тоді висохне.
                    Краще купіть у зоомагазині. Він буває спресований (його треба буде просто розмочити у воді), та живий не спресований.
                    Зі спресованих є лісовий мох та сфагнум.
            ...
            <h3>
                ...
                <p>
                    По одному укритті для полоза можете поставити в холодному та в теплому куті,
            ...
            <h3>
                ...
                <p>
                    У жодному разі напувалка не має стояти в теплому куті, бо вода не повинна нагріватися.
