    ...
    <PageContainer>
      ...
      <h3>
        ...
        <p>
          ...
          Але за умови, що вони приблизно однакового розміру, спокійно себе ведуть і не агресивні одне до одного.
        </p>
        ...
        <p>
          ...
          Для людини, яка не має багато вільного часу, змія — це найзручніша тварина, особливо така невибаглива, як маїсовий полоз.
        </p>
        <p>
          Так, любити вас змія не буде. Ніколи.
          У змій занадто простий мозок для любові й будь-яких почуттів.
          Для неї ви — &ldquo;тепле живе дерево&rdquo; і більше нічого.
